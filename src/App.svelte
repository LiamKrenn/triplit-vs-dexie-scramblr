<script lang="ts">
  ...
  import { seedPGLite, fetchTodosFromPGLite } from "./pglite";
...
<main>
  ...
  <div>
    ...
    >
    <div>Last run took {lastPGLiteSeedRun}ms</div>
    <button
      onclick={async () => {
        lastPGLiteFetchRun = await fetchTodosFromPGLite();
      }}>Fetch Todos from PGLite</button
    >
    <div>Last run took {lastPGLiteFetchRun}ms</div>
  </div>
</main>
